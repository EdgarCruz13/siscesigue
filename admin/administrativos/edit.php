...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <h1>Personal Administrativo: <?= $nombre. " ".$apellido_paterno. " ".$apellido_materno;?> </h1>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="apellido_paterno" value="<?=$apellido_paterno;?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Apellido Materno</label>
                                                <input type="text" name="apellido_materno" value="<?=$apellido_materno;?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Curp</label>
                                                <input type="text" name="curp" value="<?=$curp;?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
