                                ...
                                <tbody>
                                    ...
                                    foreach ($niveles as $nivele) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><?= $nivele['ciclo']; ?></td>
                                            <td style="text-align: center"><?= $nivele['gestion'] . " (" . $nivele['nombre_carrera'] . ")"; ?></td>
                                            <td style="text-align: center"><?= $nivele['nivel']; ?></td>
                                            <td style="text-align: center"><?= $nivele['modalidad']; ?></td>
