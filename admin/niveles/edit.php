                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="nivel" id="" class="form-control">
                                                ...
                                                <option value="DIPLOMADO" <?php if ($nivel == 'DIPLOMADO') { ?> selected="selected" <?php } ?>>DIPLOMADO</option>
                                                <option value="ESPECIALIDAD" <?php if ($nivel == 'ESPECIALIDAD') { ?> selected="selected" <?php } ?>>ESPECIALIDAD</option>
                                                <option value="TALLER" <?php if ($nivel == 'TALLER') { ?> selected="selected" <?php } ?>>TALLER</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="modalidad" id="" class="form-control">
                                                <option value="ESCORALIZADO" <?php if ($modalidad == 'ESCORALIZADO') { ?> selected="selected" <?php } ?>>ESCORALIZADO</option>
                                                <option value="SABATINO" <?php if ($modalidad == 'SABATINO') { ?> selected="selected" <?php } ?>>SABATINO</option>
                                                <option value="MIXTO" <?php if ($modalidad == 'MIXTO') { ?> selected="selected" <?php } ?>>MIXTO</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
