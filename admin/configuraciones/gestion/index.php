                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="create.php" class="btn btn-primary"><i class="bi bi-plus-square"></i> Crear nuevo periodo</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <center>Nombre de carrera</center>
                                        </th>
                                        <th>
                                            <center>Periodos</center>
                                        </th>
                                        <th>
                                            <center>Tipo periodos</center>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($gestiones as $gestione) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $gestione['ciclo']; ?></td>
                                            <td><?= $gestione['nombre_carrera']; ?></td>
                                            <td><?= $gestione['gestion']; ?></td>
                                            <td><?= $gestione['tipo_periodo']; ?></td>
    ...
    $(function() {
        $("#example1").DataTable({
            ...
            "language": {
                ...
                "infoEmpty": "Mostrando 0 a 0 de 0 Periodo",
